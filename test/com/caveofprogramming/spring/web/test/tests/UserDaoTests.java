...
public class UserDaoTests {
	...
	public void testCreateRetrieve()
	{
		...
		assertEquals("One user sould have been created and retrieved",1, users1.size());
		...
		assertEquals("Should be 4 retrievd users",4, users2.size());
	}
	@Test
	public void testUsers() {
		...
		assertFalse("User should not exist.", usersDao.exists("lakdsasdf"));
